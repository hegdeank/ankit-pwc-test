...
import { 
    ...
    getUserApprovals, updateApprovalStatus, updateUserPermissions, getUserApprovalsById, getUserApprovalsByStatus
} from "./PwCController";
...
express.get("/getUserApprovalsByStatus", getUserApprovalsByStatus);
